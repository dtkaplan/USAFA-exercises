...
For each of the following equations involving two variables, find a solution by constructing an appropriate function, making a contour plot, and locating a point on the zero contour. Plug your solution into the function to demonstrate that it is correct. (Of course, reading coordinates off a graph is not necessarily precise, so even if your coordinates are reasonable, the function value at those coordinates may not be exactly zero. But make sure that it is small.)
