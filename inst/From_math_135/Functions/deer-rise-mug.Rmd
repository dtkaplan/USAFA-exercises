...
etude::choose_one(
  prompt = "1. What is the effect on national production of a year when unemployment rises from 5% to 8%? National production will ...",
...
etude::choose_one(
  prompt = "2. What change in unemployment rate corresponds to a year when production is the same as the year before? Unemployment rate will go ...",
...
etude::choose_one(
  prompt = "3. What is the meaning of the number 3.5 in Okun's law?",
