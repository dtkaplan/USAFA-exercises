...
`r etude::exercise_title()` The surface area $S$ of a mammal is reasonably well approximated by the function $$S(M) \equiv k M ^{2/3}$$ where $M$ is the body mass (in kg) and the constant $k$ depends on the particular species under consideration. 
...
Answer the following questions. If you like, you can use the sandbox for any scratch calculations you want to do. 
