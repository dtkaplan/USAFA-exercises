...
etude::choose_one(
  ...
  choices = list(
    ...
    "It replaces the previous value of `count` by the number 1." = "Assignment evaluates the expression on the right-hand side of `<-` and stores it under the name given on the left-hand side."
  ),
  inline = FALSE
)
```
...
etude::choose_one(
  prompt = "C) What is the purpose of the last expression, `count`?",
  choices = list(
