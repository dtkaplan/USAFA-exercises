...
```{r cow-type-kayak-QA1, echo=FALSE}
etude::choose_one(
...
```{r cow-type-kayak-QA2, echo=FALSE}
etude::choose_one(
...
```{r cow-type-kayak-E1, exercise=TRUE, exercise.cap="Define log_half().", exercise.setup="cow-type-kayak-E1-setup", exercise.eval=FALSE, exercise.lines=2, exercise.completion=FALSE, exercise.startover=TRUE, exercise.diagnostics=TRUE}
log_half <- makeFun( log2(...your stuff here ...) ~ x)
```


```{r cow-type-kayak-QA4, echo=FALSE}
etude::choose_one(
...
```{r cow-type-kayak-sandbox2, exercise=TRUE, exercise.cap="Sandbox", exercise.eval=FALSE, exercise.lines=2, exercise.completion=FALSE, exercise.startover=TRUE, exercise.diagnostics=TRUE}

```

```{r cow-type-kayak-QA5, echo=FALSE}
etude::choose_one(
