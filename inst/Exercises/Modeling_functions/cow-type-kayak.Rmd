...
In the following, keep in mind the distinction between *percent* and *percentage points*.   "25% rounded to 5 percentage points" means that the original number might have been anywhere between 20% and 30%. In contrast, "25% rounded to 5%" means the original might have been in  the range 23.75% to 26.25%.
...
etude::choose_one(
  prompt = "b) The stated measurements (25% and 10%) appear rounded to about 5 percentage points.  Give a small alteration to the stated measurements (to within $\\pm 2.5$ percentage points) that would be exactly consistent with an exponential process.",
  list("Decrease to 23.6% after one hour and 5.6% after two." = explain,
