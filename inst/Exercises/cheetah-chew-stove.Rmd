...
etude::choose_one(
  ...
  choices = list(
    "2" = "",
    "+4+" = "B's a consonant, Bub.",
    "6" = "C is a consonant, Chub",
    "8" = "D is a consonant, Dear"
  )
)
```
...
```{r cheetah-chew-stove-E2, exercise=TRUE, exercise.cap="Fix this incorrect R expression.", exercise.setup="cheetah-chew-stove-E2-setup", exercise.eval=FALSE, exercise.lines=2, exercise.completion=FALSE, exercise.startover=TRUE, exercise.diagnostics=TRUE}
