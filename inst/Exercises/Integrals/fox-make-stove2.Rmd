---
chapter: "none yet"
title: "Title for fox-make-stove2"
author: "Danny Kaplan"
...
```{r fox-make-stove2-setup, include = FALSE}
library(etude)
library(learnr)
library(gradethis)
...
```{r fox-make-stove2-Qinline1, echo=FALSE}
etude::choose_one(
...
```{r fox-make-stove2-Qinline2, echo=FALSE}
...
```{r fox-make-stove2-Qinline3, echo=FALSE}
...
```{r fox-make-stove2-Qinline4, echo=FALSE}
