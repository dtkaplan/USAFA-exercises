...
```{r chicken-buy-shoe-sandbox5, exercise=TRUE, exercise.cap="Sandbox", exercise.setup="chicken-buy-shoe-sandbox5-setup", exercise.eval=FALSE, exercise.lines=2, exercise.completion=FALSE, exercise.startover=TRUE, exercise.diagnostics=TRUE}
library(COVID19)
